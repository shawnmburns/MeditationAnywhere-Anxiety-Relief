...
public class MNAudioManager {
	...
	public MNAudioManager() {
		...
		addAudio(R.raw.two_anxiety_instructions, (5*60 + 3)*1000 + 500, "2. Anxiety Instructions.mp3", "Focus...");
		addAudio(R.raw.three_anxiety_lesson, (1*60 + 23)*1000 + 500, "3. Anxiety Lesson.mp3", "Breathe...");
	}
